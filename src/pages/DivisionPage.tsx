                    ...
                    >
                      ...
                      <td className="px-2 py-3 sm:px-4 sm:py-3.5 md:px-6 font-bold flex items-center gap-2 sm:gap-4">
                        <button
                          ...
                          title={isFavorite(row.team.id, currentDivId || undefined) ? "Quitar de favoritos" : "Marcar como mi equipo favorito ⭐️"}
                        >
                          <Star className={cn("w-4 h-4 sm:w-4.5 sm:h-4.5 transition-colors", isFavorite(row.team.id, currentDivId || undefined) ? "fill-amber-400 text-amber-500 drop-shadow-xs" : "text-amber-500/50 dark:text-amber-400/50 hover:text-amber-400")} />
                        </button>
                        ...
                        <span className={cn("truncate max-w-[100px] xs:max-w-[140px] sm:max-w-none text-xs sm:text-base tracking-tight", isTop1 ? "text-primary font-extrabold" : "text-foreground", isFavorite(row.team.id, currentDivId || undefined) && "font-black text-amber-600 dark:text-amber-400")}>
